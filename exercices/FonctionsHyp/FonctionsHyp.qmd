...
::: solution
L'équation d'une chaînette est de la forme $y = a \cosh(\frac{x}{a}) + k$. Les points de suspension sont en $(-5,50)$ et $(5,50)$ et le point le plus bas est en $(0,40)$. Ainsi, nous obtenons les équations
\begin{align}
40 &= a \cosh(0) + k,\\
50 &= a \cosh(5/a) + k.
\end{align}
